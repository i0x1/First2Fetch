-- Create functions for job listing and counting
-- This migration adds utility functions for querying jobs

-- Function to list jobs with pagination and filtering
...
-- Function to count jobs by status with filtering
