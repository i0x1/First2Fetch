  ...
  return (
    <DefaultLayout>
      <section className="mx-auto my-[10vh] h-fit min-h-screen max-w-7xl px-6 md:px-10">
        ...
        <p>
          Welcome to First 2 Fetch&apos;s Privacy Policy. This policy outlines our practices regarding the collection,
          ...
          handling your personal information responsibly and transparently. This service is an upgraded version of First 2 Apply
          with performance optimizations and database improvements. By using First 2 Fetch, you agree to our Terms of Service, which outline the legal
          agreement between you and the service providers regarding your use of our service.
        </p>

        <h3 className="mt-[5vh] text-lg font-medium lg:text-2xl">Information Collection:</h3>
        <p>
          First 2 Fetch collects minimal personal information to ensure the efficient operation of our service. This
        ...
        <p>
          The information collected by First 2 Fetch is used to provide a personalized and efficient job alert service.
          ...
          information is solely focused on enhancing your experience with First 2 Fetch, ensuring you receive the most
        ...
        <p>
          First 2 Fetch values your privacy. We assure you that your personal information, including your email and
        ...
        <p>
          First 2 Fetch prioritizes the security of your personal information. We use Supabase for authentication and
        ...
        <p>
          As a user of First 2 Fetch, you have certain rights under the General Data Protection Regulation (GDPR). These
        ...
        <p>
          First 2 Fetch reserves the right to update this privacy policy at any time. Changes will be made to reflect
        ...
        <p>
          ...
          reach out to us through the GitHub repository. We are dedicated to addressing your inquiries promptly and
          ensuring your experience with First 2 Fetch is secure and satisfactory. Your input is valuable to us as we
